...
def main():
  ...
  plistpath = scriptpath + "/resources/PitchAnalyzer-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/PitchAnalyzer-AU-Info.plist"
  with open(plistpath, 'rb') as fp:
    au = plistlib.load(fp)
  ...
  plistpath = scriptpath + "/resources/PitchAnalyzer-VST3-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/PitchAnalyzer-macOS-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/resources/PitchAnalyzer-AAX-Info.plist"
  with open(plistpath, 'rb') as fp:
  ...
  plistpath = scriptpath + "/installer/PitchAnalyzer.pkgproj"
  with open(plistpath, 'rb') as fp:
  ...
  for line in fileinput.input(scriptpath + "/installer/PitchAnalyzer.iss",inplace=1):
