...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=PitchAnalyzer Demo Installer\n"
      else:
        line="OutputBaseFilename=PitchAnalyzer Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the PitchAnalyzer Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the PitchAnalyzer installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=PitchAnalyzer Demo installer\n"
     else:
       line="SetupWindowTitle=PitchAnalyzer installer\n"
